    ...
    <div class="max-w-sm mx-auto mt-4">
        ...
        <div class="flex flex-col">
            ...
            <div class="flex items-center justify-between w-full py-2">
                <img class="w-20 h-20 rounded-full" height="160" width="160"
                    src="https://avatars.githubusercontent.com/u/38668796?v=4" alt="productdevbook">
                ...
                <div
                    ...
                    <a class="hover:bg-gray-300 dark:hover:bg-gray-400" href="https://twitter.com/productdevbook"
                        target="_blank">
