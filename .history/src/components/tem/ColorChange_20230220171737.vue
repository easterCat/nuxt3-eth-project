        ...
        <Listbox v-model="$colorMode.preference" as="div" class="relative flex items-center">
            ...
            <ListboxButton type="button" title="Change Color">
                <div class="flex items-center justify-center w-10 h-10 bg-gray-100 rounded-lg dark:bg-gray-700">
                    <UnoIcon class="text-lg i-ph-palette-duotone dark:text-white" />
                </div>
            </ListboxButton>
            <ListboxOptions
                ...
                <ListboxOption v-for="color in availableColor" :key="color.id" :value="color.name"
                    class="flex items-center justify-between w-full px-3 py-2 cursor-pointer" :class="{
